...
class Online_examination{
    ...
    public void login()
    {
        ...
        loginto.put("Student1",12345);
        loginto.put("Student2",13579);
        loginto.put("Student3",24680);
    ...
    {
        System.out.println("-----------------------------------------------------");
        System.out.println("Online Examination System ---> Welcome " + Online_examination.userID + "!");
        System.out.println("-----------------------------------------------------");
    ...
    public static void main(String args[]){
    	final Online_examination exam1 = new Online_examination();
        exam1.login();
    }
}